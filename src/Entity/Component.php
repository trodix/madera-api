...
class Component
{
     ...
     * @Groups({"component", "component:input", "quotation", "module", "project", "module_component", "template_module"})
     ...
     * @Groups({"component", "quotation", "module", "project", "module_component", "template_module"})
     */
    protected $deletedAt;
